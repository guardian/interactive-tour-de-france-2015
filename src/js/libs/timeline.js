  ...
  Timeline.prototype.buildInputDialog = function () {
    ...
    this.keyEditDialog.style.cssText = "z-index: 20000; position:absolute; padding:5px; background: #DDDDDD; font-family:arial; font-size:11px; left: 100px; top:100px; border: 1px solid #AAAAAA; border-radius: 5px;";
